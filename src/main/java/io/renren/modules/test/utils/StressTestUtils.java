...
public class StressTestUtils {
     ...
     * 执行外部Python文件路径
     */
    public final static String SCRIPT_EXECUTE_FILE_HOME_KEY = "SCRIPT_EXECUTE_FILE_HOME_KEY";
    ...
    public String getScriptExecuteFileHomeKey() {
        return sysConfigService.getValue(SCRIPT_EXECUTE_FILE_HOME_KEY);
    }
